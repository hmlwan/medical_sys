<?php /*a:4:{s:56:"D:\WWW\candyworld\application\index\view\deal\index.html";i:1594735744;s:57:"D:\WWW\candyworld\application\index\view\layout\head.html";i:1591527760;s:59:"D:\WWW\candyworld\application\index\view\layout\footer.html";i:1591527760;s:56:"D:\WWW\candyworld\application\index\view\layout\nav.html";i:1592154544;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!--申明当前页面的编码集-->
...
<div class="wym-page">
    ...
    <div class="wym_header">
        ...
        <div class="wym_header_mid flexbox wrap spacebetween">
            ...
            <span class="span_line">
                <?php if($is_fill == 1): ?>
                    <input type="text" class="input_line" value="<?php echo htmlentities(app('request')->get('mobile')); ?>" readonly name="mobile" placeholder="可出售<?php echo htmlentities($fill_sale); ?>糖果"> <i class="ss_icon" id="search"></i>
                <?php else: ?>
                     <input type="text" class="input_line" value="<?php echo htmlentities(app('request')->get('mobile')); ?>" readonly name="mobile" placeholder="不符合出售条件"> <i class="ss_icon" id="search"></i>
                <?php endif; ?>
            </span>
        </div>
    </div>
...
<div class="order_tips_pop ye_pop" style="display: none">
    <div class="order_tips_pop_view">
        ...
        <p>您的账户余额不足<?php echo htmlentities($trade_fine_num); ?>糖果不能解封，您可以在问题反馈页面联系客服解封，仅只有一次机会。</p>
        <p class="btn text_center">
            <span>确定</span>
        </p>
    </div>
