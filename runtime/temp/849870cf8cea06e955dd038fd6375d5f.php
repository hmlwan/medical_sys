<?php /*a:4:{s:63:"D:\WWW\candyworld\application\index\view\member\memberinfo.html";i:1594735109;s:57:"D:\WWW\candyworld\application\index\view\layout\head.html";i:1591527760;s:59:"D:\WWW\candyworld\application\index\view\layout\footer.html";i:1591527760;s:56:"D:\WWW\candyworld\application\index\view\layout\nav.html";i:1592154544;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!--申明当前页面的编码集-->
...
<div  class="wd-page">
    ...
    <div class="wd-middle">
        <div class="middle-l" id="show_magic">
            <img src="/static/img/newimg/tg88.png" alt="">
            <p class="title">总资产(糖果)</p>
            <!--<p><?php echo htmlentities($list->show_magic); ?> <em> ≈ ¥<?php echo htmlentities($list->show_magic); ?></em></p>-->
            <p class="show_magic" >≈ <?php echo htmlentities($market_money_num); ?> <em style="font-weight: normal;font-size: .26rem">CNY</em></p>
            <p>查看详情 ></p>
        </div>
    </div>
...
<script>
    ...
    document.getElementById('show_magic').addEventListener('tap', function () {
        mui.openWindow({
            url: "<?php echo url('assets'); ?>",
            id: 'show_magic',
        })
    });
