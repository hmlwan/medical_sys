...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px" >
        <form class="form-horizontal" method="post" action="/admin/Config/adds" role="form" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label">跳转链接</label>

                <div class="col-sm-5">
                    <input type="text" value="" name="url" class="form-control"
                           placeholder="跳转链接加http://">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                   <select name="types" class="form-control">
                   	   ...
                   	   <option value="2">任务页</option>
                   	   <option value="3">邀请页</option>
                   </select>
                </div>
