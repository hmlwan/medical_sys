...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <div class="form-group">
                ...
                <a type="button" href="/admin/Config/sladd" class="btn btn-info">添加轮播图</a>
            </div>
        <table class="table table-bordered table-striped no-margin">
            ...
            <tr>
                ...
                <td class="text-center" style="vertical-align: middle; ">
                    ...
                    <a href="<?php echo htmlentities($config->img); ?>" target="_blank">
                        <img src="<?php echo htmlentities($config->img); ?>" alt="" style="max-width:150px;max-height: 120px">
                    </a>

                </td>
                <td class="text-center" style="vertical-align: middle; ">

                     <?php if($config->types == 1): ?>
                        首页显示
                     <?php elseif($config->types == 2): ?>
                        任务页显示
                    <?php elseif($config->types ==3): ?>
                        邀请页显示
                    <?php else: endif; ?>
                </td>
                <td class="text-center" style="vertical-align: middle; ">
                ...
                <td class="text-center" style="vertical-align: middle; ">
                    <a class="btn btn-xs btn-primary" href="/admin/Config/sladds?id=<?php echo htmlentities($config->id); ?>">确认修改</a>

                     <a data-url="<?php echo url('Config/deletes',['id'=>$config->id]); ?>" onclick="main.ajaxDelete(this)"
