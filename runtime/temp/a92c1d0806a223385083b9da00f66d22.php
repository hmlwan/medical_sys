...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <div class="form-group">
            <a type="button" href="/admin/Turntable/turntableEdit" class="btn btn-info">添加糖果</a>
        </div>
        <table class="table table-bordered table-striped no-margin">
            ...
            <tr>
                <td class="text-center" style="vertical-align: middle; "><?php echo htmlentities($item->sort); ?></td>

                <td class="text-center" style="vertical-align: middle; ">
                
                     <img src="<?php echo htmlentities($item->img); ?>" alt="" style="width:60px;height: 60px">

                </td>
                <td class="text-center" style="vertical-align: middle; ">
                    <?php echo htmlentities($item->num); ?>糖果
                </td>
                <td class="text-center" style="vertical-align: middle; ">
                    <?php echo htmlentities($item->des); ?>
                </td>
                <td class="text-center" style="vertical-align: middle; ">
                ...
                <td class="text-center" style="vertical-align: middle; ">
                    <a class="btn btn-xs btn-primary" href="/admin/Turntable/turntableEdit?id=<?php echo htmlentities($item->id); ?>">确认修改</a>
                    <?php if($item->status == 1): ?>
                    <a class="btn btn-xs btn-danger" data-url="<?php echo url('turntableStatus',['id'=>$item->id,'status'=>0]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定禁用吗？">禁用</a>
                    <?php else: ?>
                    <a class="btn btn-xs btn-primary" data-url="<?php echo url('turntableStatus',['id'=>$item->id,'status'=>1]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定解禁吗？">解禁</a>
                    <?php endif; if($item->is_drawn == 1): ?>
                    <a class="btn btn-xs btn-danger" data-url="<?php echo url('turntableDrawn',['id'=>$item->id,'is_drawn'=>0]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定关闭中奖吗？">关闭中奖</a>
                    <?php else: ?>
                    <a class="btn btn-xs btn-primary" data-url="<?php echo url('turntableDrawn',['id'=>$item->id,'is_drawn'=>1]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定开启中奖吗？">开启中奖</a>
                    <?php endif; ?>
                     <a data-url="<?php echo url('Turntable/turntableDel',['id'=>$item->id]); ?>" onclick="main.ajaxDelete(this)"
