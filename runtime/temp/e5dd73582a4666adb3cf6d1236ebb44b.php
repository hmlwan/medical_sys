<?php /*a:3:{s:76:"C:\wwwroot\www.dayuli.cn\application\index\view\welfare\candy_turntable.html";i:1592201902;s:64:"C:\wwwroot\www.dayuli.cn\application\index\view\layout\head.html";i:1591527760;s:66:"C:\wwwroot\www.dayuli.cn\application\index\view\layout\footer.html";i:1591527760;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!--申明当前页面的编码集-->
...
<body class="tgzp_body">
    ...
    <div class="tgzp-page">
        <div class="tgzp_header">
            ...
            <p>
                <span  class="dbbb_icon">我的云链<i class="tgs_bkg"><?php echo htmlentities($candy_num); ?></i></span>
            </p>
        </div>
                ...
                <?php foreach($list as $item): if($item['type'] == '1'): ?>
                    ...
                    <?php elseif($item['type'] == '2'): ?>
                        <li class="an_btn flexbox column" is_start="0" id="begin">
                            <span style="margin-top: 0.6rem;"><?php echo htmlentities($turntable_luckdraw_consume_candy); ?>云链</span>
                            <span>抽大奖</span>
                        </li>
                    <?php else: ?>
                        <li>
