...
<div class="dhkj-page">
    ...
    <div class="dhkj_content">
        ...
        <form id="product-form<?php echo htmlentities($key); ?>" action="<?php echo url('product/do_rehire'); ?>" method="post" onsubmit="return false">
            <input type="hidden" name="record_id" value="<?php echo htmlentities($item['id']); ?>">
