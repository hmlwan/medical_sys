...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px" >
        <form class="form-horizontal" method="post" action="/admin/Config/sladdss" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                   <select name="types" class="form-control">
                   	   <option value="1"   <?php if($info['types'] == 1): ?> selected  <?php endif; ?>>首页</option>
                   	   <option value="2"   <?php if($info['types'] == 2): ?> selected  <?php endif; ?>>任务页</option>
                   	   <option value="3"   <?php if($info['types'] == 3): ?> selected  <?php endif; ?>>邀请页</option>
                   </select>
                </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" name="sub"  class="btn btn-primary">修改
                    </button>
                </div>
            </div>
        </form>
