...
<section class="panel">
    ...
    <div class="panel-body" style="padding-bottom: 50px">
        <div class="form-group">
                ...
                <a type="button" href="/admin/Adv/advAdd" class="btn btn-info">添加广告位</a>
            </div>
        <table class="table table-bordered table-striped no-margin">
            ...
            <tr>
                <td class="text-center" style="vertical-align: middle; "><?php echo htmlentities($item->id); ?></td>

                <td class="text-center" style="vertical-align: middle; ">
                    <img src=" <?php echo htmlentities((isset($item->ad_logo) && ($item->ad_logo !== '')?$item->ad_logo:'')); ?>" style="width: 100px;height: 100px" alt="">
                </td>
                <td class="text-center" style="vertical-align: middle; ">
                    <?php echo htmlentities($item->ad_url); ?>
                </td>
                <td class="text-center" style="vertical-align: middle; ">
                    <?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($item->op_time)? strtotime($item->op_time) : $item->op_time)); ?>
                </td>
                <td class="text-center" style="vertical-align: middle; ">
                ...
                <td class="text-center" style="vertical-align: middle; ">
                    <a class="btn btn-xs btn-primary" href="/admin/Adv/advEdit?id=<?php echo htmlentities($item->id); ?>">确认修改</a>
                    <?php if($item->status == 1): ?>
                    <a class="btn btn-xs btn-danger" data-url="<?php echo url('advStatus',['id'=>$item->id,'status'=>0]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定禁用吗？">禁用</a>
                    <?php else: ?>
                    <a class="btn btn-xs btn-primary" data-url="<?php echo url('advStatus',['id'=>$item->id,'status'=>1]); ?>" onclick="main.ajaxDelete(this)" data-msg="确定解禁吗？">解禁</a>
                    <?php endif; ?>
                    <a data-url="<?php echo url('Adv/advDel',['id'=>$item->id]); ?>" onclick="main.ajaxDelete(this)"
