...
<div class="receive_reward" style="display: <?php if($is_jump_ad != 1): ?>inline_block<?php else: ?>none<?php endif; ?>">
    ...
    <p class="candy">获得<em><?php echo htmlentities((isset($condy_sum_num) && ($condy_sum_num !== '')?$condy_sum_num:"0.00")); ?></em>云链</p>
