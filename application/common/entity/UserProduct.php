    ...
    public function addInfo($userId, $productId, $type)
    {
        ...
        try {
            ...
            $prod_data = array(
                ...
                'is_receive' => 0,
                'candy_num' =>  $product->candy_num,
                'return_candy_num' =>  $product->return_candy_num,
                'energy_num' =>  $product->energy_num,
                'types' =>  1,
            );

            $r = \app\common\entity\Product::addProductRecord($prod_data);
            if(!$r){
                return false;
            }
